    ...
    <form class="layui-form" action="">
        <div class="addrcon">
            <ul>
                ...
                <li><em>所在区域</em><input type="text" name="address_area" placeholder="请选择所在区域"></li>
                <li class="addr-detail"><em>详细地址</em><input type="text" name="address_mail" placeholder="20个字以内" class="addr"></li>
            </ul>
            <div class="setnormal"><span>设为默认地址</span>
                <input type="checkbox" id="box" name="xxx" lay-skin="switch">
            </div>
