...
@section('content')
    ...
    <div>
        <div class="g-pay-lst" order_id="{{$id}}">
            <ul>
                @foreach($data as $v)
                <li class="goods_id" goods_id="{{$v->goods_id}}">
                    <a href="">
                        <span>
            ...
            <p class="gray9">总需支付金额：<em class="orange"><i>￥</i>{{$num}}</em></p>
        </div>
        <div class="other_pay marginB">
            ...
            <a href="javascript:;" class="wzf checked">
                <b class="z-set"></b>第三方支付<em class="orange fr"><span class="colorbbb">需要支付&nbsp;</span><b>￥</b>{{$num}}</em>
            </a>
            <div class="net-pay">
        ...
        <div class="g-Total-bt">
            <dd><a id="price" href="javascript:;" class="orangeBtn fr w_account">立即支付</a></dd>
        </div>
...
@section('my-js')
    <script>
        ...
        $("#price").click(function(){
            var order_id=$(".g-pay-lst").attr('order_id');
            location.href="{{'/alipay/mobilepay'}}/"+order_id;
